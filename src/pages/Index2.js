        ...
        <div id="main_content">
            ...
            <div class="container">
              <div class="hleft">
                ...
                <div class="dropdown">
                  ...
                  <a href="app-calendar.html" class="nav-link icon app_inbox">
                    <i class="fa fa-calendar"></i>
                  </a>
                  <a href="app-contact.html" class="nav-link icon xs-hide">
                    <i class="fa fa-id-card-o"></i>
                  </a>
                  <a href="app-chat.html" class="nav-link icon xs-hide">
                    <i class="fa fa-comments-o"></i>
                  </a>
                  <a
                    href="app-filemanager.html"
                    class="nav-link icon app_file xs-hide"
                  >
              ...
              <div class="hright">
                <div class="dropdown">
                  ...
                  <a
                    ...
                    class="nav-link icon menu_toggle"
                  >
          ...
          <div id="rightsidebar" class="right_sidebar">
            ...
            <div class="tab-content">
              ...
              >
                <div class="mb-4">
                  <h6 class="font-14 font-weight-bold text-muted">
                    Font Style
                  </h6>
                ...
                <div class="form-group">
                  <label class="d-block">
                    Storage <span class="float-right">77%</span>
                  </label>
          ...
          <div class="user_div">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label class="d-block">
                    Total Income<span class="float-right">77%</span>
                  </label>
                ...
                <div class="form-group">
                  <label class="d-block">
                    Total Expenses <span class="float-right">50%</span>
                  </label>
                  <div class="progress progress-xs">
                    <div
                ...
                <div class="form-group mb-0">
                  <label class="d-block">
                    Gross Profit <span class="float-right">23%</span>
                  </label>
                  <div class="progress progress-xs">
                    <div
            ...
            <div class="card b-none">
              <ul class="list-group">
                <li class="list-group-item d-flex">
                  <div class="box-icon sm rounded bg-blue">
                ...
                <li class="list-group-item d-flex">
                  <div class="box-icon sm rounded bg-pink">
                ...
                <li class="list-group-item d-flex">
                  <div class="box-icon sm rounded bg-teal">
                ...
                <li class="list-group-item d-flex">
                  <div class="box-icon sm rounded bg-cyan">
                ...
                <div class="right">
                  <ul class="nav nav-pills">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="#">
                          <i class="dropdown-icon fa fa-file-excel-o"></i> MS
                          Excel
                        </a>
                        <a class="dropdown-item" href="#">
                          <i class="dropdown-icon fa fa-file-word-o"></i> MS
                          Word
                        </a>
                        <a class="dropdown-item" href="#">
                          <i class="dropdown-icon fa fa-file-pdf-o"></i>
                          PDF
                        </a>
                      </div>
                    </li>
                  ...
                  <div class="notification d-flex">
                    ...
                    <div class="dropdown d-flex">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="javascript:void(0)">
                          <i class="dropdown-icon fe fe-help-circle"></i> Need
                          help?
                        </a>
                  ...
                  <div class="card">
                    ...
                    <div class="card-footer">
                      <div class="d-flex justify-content-between align-items-center">
                        <a
                          href="javascript:void(0)"
                          class="btn btn-info btn-sm w200 mr-3"
                        >
                          Generate Report
                        </a>
                        <small>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body text-center">
                      ...
                      <h3 class="mb-0 mt-3 font300">
                        <span class="counter">1,24,301</span>{" "}
                        <span class="text-green font-15">+3.7%</span>
                      </h3>
                      <small>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <span>Balance</span>
                      <h4>
                        $<span class="counter">20,508</span>
                      </h4>
                      ...
                      <div class="form-group">
                        <label class="d-block">
                          Bank of America{" "}
                          <span class="float-right">
                            $<span class="counter">15,025</span>
                          </span>
                        </label>
                        <div class="progress progress-xs">
                          <div
                        ...
                        <table class="table table-hover table-striped text-nowrap table-vcenter mb-0">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>Done</td>
                              <td>
                                <span class="tag tag-orange">Submit</span>
                              </td>
                            </tr>
                            <tr>
                              <td>#AD1245</td>
